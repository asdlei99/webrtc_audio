...
LOCAL_C_INCLUDES :=  \
    ...
    $(LOCAL_PATH)/../external/webrtc/modules/audio_processing/ns \
    $(LOCAL_PATH)/../external/webrtc/modules/audio_processing/aec \
    $(LOCAL_PATH)/../external/webrtc/modules/audio_processing/agc/legacy \
